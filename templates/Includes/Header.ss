<!--<header class="navbar navbar-inverse navbar-fixed-top" role="banner">
  <div class="container">
    ...
    <nav class="navbar-collapse collapse" role="navigation"><% include Navigation %></nav>
    <!/.nav-collapse>
  </div>
</header>-->
                ...
                <div class="container">
                    ...
                    <div class="c-brand">
                        <a href="index.html" class="c-logo">
                            <img src="$ThemeDir/dist/images/logos/logo.png" width="87" height="21" alt="JIM e.V." class="c-desktop-logo">
